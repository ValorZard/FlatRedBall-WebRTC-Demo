...
{
    public partial class SliderRuntime : global::test_webrtc.GumRuntimes.ContainerRuntime, global::test_webrtc.GumRuntimes.ISliderBehavior
    {
        #region State Enums
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentSliderCategoryState)
                    {
                        case  SliderCategory.Enabled:
                            ThumbInstance.CurrentButtonCategoryState = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                            FocusedIndicator.Visible = false;
                            break;
                        ...
                        case  SliderCategory.Highlighted:
                            ThumbInstance.CurrentButtonCategoryState = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (SliderCategory firstState, SliderCategory secondState, float interpolationValue) 
        {
            ...
            global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory ThumbInstanceCurrentButtonCategoryStateFirstValue= global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
            global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory ThumbInstanceCurrentButtonCategoryStateSecondValue= global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
            switch(firstState)
            {
                case  SliderCategory.Enabled:
                    if (interpolationValue < 1)
                    ...
                    ThumbInstanceCurrentButtonCategoryStateFirstValue = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                    break;
                case  SliderCategory.Focused:
                    if (interpolationValue < 1)
                    {
                ...
                case  SliderCategory.Highlighted:
                    ...
                    setThumbInstanceCurrentButtonCategoryStateFirstValue = true;
                    ThumbInstanceCurrentButtonCategoryStateFirstValue = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                    break;
                case  SliderCategory.HighlightedFocused:
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  SliderCategory.Enabled:
                    ...
                    ThumbInstanceCurrentButtonCategoryStateSecondValue = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                    break;
                case  SliderCategory.Focused:
                    if (interpolationValue >= 1)
                    {
                ...
                case  SliderCategory.Highlighted:
                    ...
                    setThumbInstanceCurrentButtonCategoryStateSecondValue = true;
                    ThumbInstanceCurrentButtonCategoryStateSecondValue = global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                    break;
                case  SliderCategory.HighlightedFocused:
                    if (interpolationValue >= 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.SliderRuntime.VariableState fromState,global::test_webrtc.GumRuntimes.Controls.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.SliderRuntime.SliderCategory fromState,global::test_webrtc.GumRuntimes.Controls.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        global::test_webrtc.GumRuntimes.ISliderBehavior.SliderCategory global::test_webrtc.GumRuntimes.ISliderBehavior.CurrentSliderCategoryState
        {
            set
            {
                switch(value)
                {
                    case  global::test_webrtc.GumRuntimes.ISliderBehavior.SliderCategory.Enabled:
                        this.CurrentSliderCategoryState = SliderCategory.Enabled;
                        break;
                    case  global::test_webrtc.GumRuntimes.ISliderBehavior.SliderCategory.Focused:
                        this.CurrentSliderCategoryState = SliderCategory.Focused;
                        break;
                    case  global::test_webrtc.GumRuntimes.ISliderBehavior.SliderCategory.Highlighted:
                        this.CurrentSliderCategoryState = SliderCategory.Highlighted;
                        break;
                    case  global::test_webrtc.GumRuntimes.ISliderBehavior.SliderCategory.HighlightedFocused:
        ...
        public global::test_webrtc.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
        public global::test_webrtc.GumRuntimes.NineSliceRuntime NineSliceInstance { get; set; }
        public global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime ThumbInstance { get; set; }
        ...
        {
            TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as global::test_webrtc.GumRuntimes.ContainerRuntime;
            NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as global::test_webrtc.GumRuntimes.NineSliceRuntime;
            ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as global::test_webrtc.GumRuntimes.Controls.ButtonStandardRuntime;
