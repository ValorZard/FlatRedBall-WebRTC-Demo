...
{
    public partial class ComboBoxRuntime : global::test_webrtc.GumRuntimes.ContainerRuntime, global::test_webrtc.GumRuntimes.IComboBoxBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Background.CurrentStyleCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                        TextInstance.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.White;
                        TextInstance.CurrentStyleCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                        IconInstance.CurrentIconCategoryState = global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.Arrow2;
                        IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentComboBoxCategoryState)
                    {
                        ...
                        case  ComboBoxCategory.Highlighted:
                            TextInstance.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                            IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ComboBoxCategory.Pushed:
                            TextInstance.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                            IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateFirstValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
                    ...
                    TextInstanceCurrentStyleCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateSecondValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                    ...
                    TextInstanceCurrentStyleCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue >= 1)
                    {
                        this.TextInstance.Text = "Selected Item";
                    }
        ...
        public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue < 1)
                    {
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue >= 1)
                    {
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue >= 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ComboBoxRuntime.VariableState fromState,global::test_webrtc.GumRuntimes.Controls.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory fromState,global::test_webrtc.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory global::test_webrtc.GumRuntimes.IComboBoxBehavior.CurrentComboBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Enabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Enabled;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Disabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Disabled;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Highlighted:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Highlighted;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Pushed:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Pushed;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.HighlightedFocused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.HighlightedFocused;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Focused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Focused;
                        break;
                    case  global::test_webrtc.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.DisabledFocused:
        ...
        public global::test_webrtc.GumRuntimes.Controls.ListBoxRuntime ListBoxInstance { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as global::test_webrtc.GumRuntimes.Controls.ListBoxRuntime;
