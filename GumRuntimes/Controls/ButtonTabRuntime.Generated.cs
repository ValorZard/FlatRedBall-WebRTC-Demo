...
{
    public partial class ButtonTabRuntime : global::test_webrtc.GumRuntimes.ContainerRuntime, global::test_webrtc.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Background.CurrentStyleCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                        TabText.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.White;
                        TabText.CurrentStyleCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        ...
                        case  ButtonCategory.Disabled:
                            ...
                            TabText.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.Gray;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory TabTextCurrentColorCategoryStateFirstValue= global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.Black;
            global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory TabTextCurrentColorCategoryStateSecondValue= global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.Black;
            bool setTabTextCurrentStyleCategoryStateFirstValue = false;
            bool setTabTextCurrentStyleCategoryStateSecondValue = false;
            global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory TabTextCurrentStyleCategoryStateFirstValue= global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Tiny;
            global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory TabTextCurrentStyleCategoryStateSecondValue= global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Tiny;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateFirstValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                    ...
                    TabTextCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.White;
                    if (interpolationValue < 1)
                    {
                    ...
                    TabTextCurrentStyleCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateSecondValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.TabBordered;
                    ...
                    TabTextCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.White;
                    if (interpolationValue >= 1)
                    {
                        this.TabText.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToContainer;
                    }
                    ...
                    TabTextCurrentStyleCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.StyleCategory.Strong;
                    if (interpolationValue >= 1)
                    {
                        this.TabText.Text = "Tab 1";
                    }
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ButtonCategory.Disabled:
                    ...
                    setTabTextCurrentColorCategoryStateFirstValue = true;
                    TabTextCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.Gray;
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
            ...
            switch(secondState)
            {
                ...
                case  ButtonCategory.Disabled:
                    ...
                    setTabTextCurrentColorCategoryStateSecondValue = true;
                    TabTextCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.TextRuntime.ColorCategory.Gray;
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateSecondValue = true;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ButtonTabRuntime.VariableState fromState,global::test_webrtc.GumRuntimes.Controls.ButtonTabRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ButtonTabRuntime.ButtonCategory fromState,global::test_webrtc.GumRuntimes.Controls.ButtonTabRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        public global::test_webrtc.GumRuntimes.TextRuntime TabText { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            TabText = this.GetGraphicalUiElementByName("TabText") as global::test_webrtc.GumRuntimes.TextRuntime;
