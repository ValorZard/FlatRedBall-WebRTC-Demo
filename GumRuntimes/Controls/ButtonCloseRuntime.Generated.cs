...
{
    public partial class ButtonCloseRuntime : global::test_webrtc.GumRuntimes.ContainerRuntime, global::test_webrtc.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        Background.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                        Background.CurrentStyleCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.StyleCategory.Bordered;
                        Icon.CurrentIconCategoryState = global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        case  ButtonCategory.Enabled:
                            Background.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                            Icon.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.White;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ButtonCategory.Disabled:
                            ...
                            Icon.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ButtonCategory.Highlighted:
                            Background.CurrentColorCategoryState = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                            Icon.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.White;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory IconCurrentIconCategoryStateFirstValue= global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.None;
            global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory IconCurrentIconCategoryStateSecondValue= global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.None;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                    ...
                    IconCurrentIconCategoryStateFirstValue = global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Danger;
                    ...
                    IconCurrentIconCategoryStateSecondValue = global::test_webrtc.GumRuntimes.Elements.IconRuntime.IconCategory.Close;
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  ButtonCategory.Enabled:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.White;
                    }
                    break;
                case  ButtonCategory.Disabled:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = global::test_webrtc.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                    }
                    break;
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
                    BackgroundCurrentColorCategoryStateFirstValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                    if (interpolationValue < 1)
                    {
                        this.FocusedIndicator.Visible = false;
                    }
            ...
            switch(secondState)
            {
                ...
                case  ButtonCategory.Highlighted:
                    setBackgroundCurrentColorCategoryStateSecondValue = true;
                    BackgroundCurrentColorCategoryStateSecondValue = global::test_webrtc.GumRuntimes.NineSliceRuntime.ColorCategory.Warning;
                    if (interpolationValue >= 1)
                    {
                        this.FocusedIndicator.Visible = false;
                    }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ButtonCloseRuntime.VariableState fromState,global::test_webrtc.GumRuntimes.Controls.ButtonCloseRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::test_webrtc.GumRuntimes.Controls.ButtonCloseRuntime.ButtonCategory fromState,global::test_webrtc.GumRuntimes.Controls.ButtonCloseRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        public global::test_webrtc.GumRuntimes.Elements.IconRuntime Icon { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            Icon = this.GetGraphicalUiElementByName("Icon") as global::test_webrtc.GumRuntimes.Elements.IconRuntime;
